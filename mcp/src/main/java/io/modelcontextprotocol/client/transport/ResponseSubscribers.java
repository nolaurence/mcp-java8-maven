...
class ResponseSubscribers {
    ...
    protected interface ResponseEvent {
        ResponseInfo responseInfo();
    }

    @Data
    @AllArgsConstructor
    public static class DummyEvent implements ResponseEvent {
    ...
    @Data
    @AllArgsConstructor
    public static class SseResponseEvent implements ResponseEvent {
        private ResponseInfo responseInfo;
...
//        }
    ...
    @Data
    @AllArgsConstructor
    public static class AggregateResponseEvent implements ResponseEvent {
        private ResponseInfo responseInfo;
        private String data;
